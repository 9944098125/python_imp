...
const python_qa = [
  ...
  },
  {
      ...
      answer:"Data abstraction is the reduction of a particular body of data to a simplified representation of the whole. Data abstraction refersto providing only essential information to the outside world and hiding their background details"
  }
];
...
app.listen(port, () => console.log(`App Listening to https://localhost:${port}`));